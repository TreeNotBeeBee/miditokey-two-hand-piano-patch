...
| 声部 | 白键 | 黑键 | 默认音区 | 移动八度 |
|---|---|---|---|---|
| 右手/上排 | `Q W E R T Y U` | `2 3 5 6 7` | C4–B4 | 左 Shift 降，右 Shift 升 |
| 左手/下排 | `Z X C V B N M` | `S D G H J` | C3–B3 | 左 Ctrl 降，右 Ctrl 升 |
...
3. 下排默认从 C3 开始，上排默认从 C4 开始。
4. 单独轻点左/右 Ctrl 调整下排，单独轻点左/右 Shift 调整上排。
5. 标题中的 `左手 C3-B3 | 右手 C4-B4` 会随切换更新。
